...
use \App\FoxdoxProvider;

class FoxdoxProviderAuthProvider extends EloquentUserProvider implements UserProvider
{
    ...
    public function retrieveByCredentials(array $credentials)
    {
        ...
        if($this->response->Status===HTTPSTATUSCODES::HTTP_OK){
            return FoxdoxProvider::where('name', $credentials['name'])->first();
        }
    }
